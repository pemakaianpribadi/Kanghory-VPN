...
sleep 2
clear
wget -q -O ssh-vpnfix.sh https://raw.githubusercontent.com/kanghoryVPN/Autoscript-by-azi/main/autoscript-ssh-slowdns-main/ssh-vpnfix.sh && chmod +x ssh-vpnfix.sh && ./ssh-vpnfix.sh
sleep 2
clear
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Credit By KANG HORY VPN ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ADIOS"
